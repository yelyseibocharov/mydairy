...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/windowteacher.css">
...
<?php
                    if (isset($_POST["name"])) {
                        ...
                        teacheradr='{$_POST["address"]}', teacheremail='{$_POST["email"]}' where idteacher='{$_GET["names"]}'";
...
?>     
    <main>
                ...
                <div id="tab-2" class="tabs-content__item">    
                    <div class="peopleinfo"> 
                        <div class="first-line"> 
                            ...
                            <?
                            $sql="SELECT * from teacher where idteacher='{$_GET['names']}'";
        ...
        <script src="js/editinfo-windowteacher.js"></script>
