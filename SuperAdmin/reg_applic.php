...
<head>
    ...
    <link rel="stylesheet" href="css/reg_applic.css">
        ...
        <article class="content">
            ...
            <section class="content__right">
                <div class="head__name">    
                    <h1>Заяви на реєстрацію</h1>
                </div>    
                <div class="schools">
                    <div class="schoolinfo">
                        <div class="schoolinfo__name">
                            <h3>Назва закладу:</h3>
                            <text>Харківський ліцей №149</text>
                        </div>
                        <div class="schoolinfo__town">
                            <h3>Місто:</h3>
                            <text>Харків</text>
                        </div>
                        <div class="schoolinfo__director">
                            <h3>Директор:</h3>
